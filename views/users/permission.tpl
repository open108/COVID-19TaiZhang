              ...
              <section id="unseen">
                <form id="permission-form">
                  <ul class="list-unstyled">
                    ...
                    <li data-pmodel="用户相册-album-plane||album-list" class="border">
                      <h4>用户相册</h4>
                      <ul class="list-unstyled">
                        <li>
                          <div class="form-group">
                    ...
                    <li data-pmodel="用户管理-user-user||#" class="border">
                      ...
                      <ul class="list-unstyled">
                        <li>
                          <div class="form-group" data-cmodel="用户-user||user-manage"> 用户：
                            <label class="checkbox-inline">
                        ...
                        <li>
                          <div class="form-group" data-cmodel="职务-user||position-manage"> 职务：
                            <label class="checkbox-inline">
