...
func (this *AjaxStatusPositionController) Post() {
	...
	if id <= 0 {
		this.Data["json"] = map[string]interface{}{"code": 0, "message": "请选择职务"}
		this.ServeJSON()
		return
	}
	...
	if err == nil {
		this.Data["json"] = map[string]interface{}{"code": 1, "message": "职务状态更改成功"}
	} else {
		this.Data["json"] = map[string]interface{}{"code": 0, "message": "职务状态更改失败"}
	}
	this.ServeJSON()
}
...
func (this *AddPositionController) Post() {
	...
	if err == nil {
		this.Data["json"] = map[string]interface{}{"code": 1, "message": "职务添加成功"}
	} else {
		this.Data["json"] = map[string]interface{}{"code": 0, "message": "职务添加失败"}
	}
	this.ServeJSON()
}
...
func (this *EditPositionController) Post() {
	...
	if err != nil {
		this.Data["json"] = map[string]interface{}{"code": 0, "message": "职务不存在"}
		this.ServeJSON()
		return
	}
